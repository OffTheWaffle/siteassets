...
<head>
	...
	<meta name="description" content="Off the Waffle is a family run business of waffle enthusiasts located in both Portland and Eugene Oregon specializing in authentic Belgium Liege waffles.">
...
<ul id="instagramList"></ul>
			...
			<div id="brownMenuContainer">
				...
				<ul id="brownSubmenu">
					...
					<li><a href="pdfs/SE_Portland_Menu.pdf" target="_blank">Southeast Portland (pdf)</a></li>
