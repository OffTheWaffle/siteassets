     	...
     	<div id="subwidget">
			<div id="title_w"><?php echo $heading_title; ?></div>
             <?php if ($error_warning) { ?>
              ...
              <?php } ?>
 			<div id="content">            
				<div id="notiffy-server">  <?php echo $text_description; ?></div>
 				...
 				<div id="regbox-button">                   
                    <div class="content">
                      <div class="left"><span class="required">*</span> <?php echo $entry_firstname; ?><br />
                        <input type="text" id="text-medium" name="firstname" value="<?php echo $firstname; ?>" class="large-field" />
                        <br />
                        ...
                        <input type="text" id="text-medium" name="lastname" value="<?php echo $lastname; ?>" class="large-field" />
                        <br />
                        ...
                        <input type="text" id="text-medium" name="email" value="<?php echo $email; ?>" class="large-field" />
                        <br />
                        <?php if ($error_email) { ?>
                        ...
                        <input type="text" id="text-medium" name="telephone" value="<?php echo $telephone; ?>" class="large-field" />
                        <br />
                      ...
                      <div class="right"><span class="required">*</span> <?php echo $entry_order_id; ?><br />
                        <input type="text" id="text-medium" name="order_id" value="<?php echo $order_id; ?>" class="large-field" />
                        <br />
                        ...
                        <input type="text" id="text-medium" name="date_ordered" value="<?php echo $date_ordered; ?>" class="large-field date" />
                        <br />
                      </div>
                    </div>
                  </div>
 	          ...
 	          <div id="regbox-button">      
                    <div id="return-product">
                        ...
                        <div class="content">
                          <div class="return-product">
                            <div class="return-name"><span class="required">*</span> <b><?php echo $entry_product; ?></b><br />
                              <input type="text" id="text-medium" name="return_product[<?php echo $return_product_row; ?>][name]" value="<?php echo $return_product['name']; ?>" />
                              <br />
                            ...
                            <div class="return-model"><span class="required">*</span> <b><?php echo $entry_model; ?></b><br />
                              <input type="text" id="text-medium" name="return_product[<?php echo $return_product_row; ?>][model]" value="<?php echo $return_product['model']; ?>" />
                              <br />
                            ...
                            <div class="return-quantity"><b><?php echo $entry_quantity; ?></b><br />
                              <input type="text" id="text-medium" name="return_product[<?php echo $return_product_row; ?>][quantity]" value="<?php echo $return_product['quantity']; ?>" />
                            </div>
                          </div>
                          ...
                          <div class="return-detail">
                            ...
                            <div class="return-remove"><a onclick="$('#return-product-row<?php echo $return_product_row; ?>').remove();" class="buttonlarge"><span><?php echo $button_remove; ?></span></a></div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div id="right"><a onclick="addReturnProduct();" class="buttonlarge"><span><?php echo $button_add_product; ?></span></a></div>
                    </div>
				...
				<div id="regbox-button">                    
					...
					<div id="regbox-button">
                      ...
                      <div id="right"><a onclick="$('#return').submit();" class="buttonlarge"><span><?php echo $button_continue; ?></span></a></div>
                    </div>
                  </form>
