...
<?php echo $content_top; ?>
    ...
    <?php echo $column_left; ?>
                        ...
                        <tbody >
                          ...
                          <tr>
                            ...
                            <td class="price"><?php if ($product['price']) { ?>
                              ...
                              <?php } ?></td>
                            <td class="cart"><a onclick="addToCart('<?php echo $product['product_id']; ?>');" class="buttonlarge"><span><?php echo $button_cart; ?></span></a></td>
                          </tr>
                          <?php } ?>
                        </tbody>
                      </table>
        ...
        <a href="<?php echo $back; ?>" class="buttonlarge"><span><?php echo $button_back; ?></span></a>
                        ...
                        <div id="right">
        <a onclick="$('#wishlist').submit();" class="buttonlarge"><span><?php echo $button_update; ?></span></a>
                        </div>
                  ...
                  <div class="buttons">
                    <div class="right"><a href="<?php echo $continue; ?>" class="buttonlarge"><span><?php echo $button_continue; ?></span></a></div>
                  </div>
                  <?php } ?>
