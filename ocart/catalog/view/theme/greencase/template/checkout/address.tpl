...
<div id="<?php echo $type; ?>-new" style="display: none;">
  <table class="form">
    <tr>
      ...
      <td><input type="text" id="text-medium" name="firstname" value="" class="large-field" /></td>
    </tr>
    <tr>
      <td><span class="required">*</span> <?php echo $entry_lastname; ?></td>
      <td><input type="text" id="text-medium" name="lastname" value="" class="large-field" /></td>
    </tr>
    <tr>
      <td><?php echo $entry_company; ?></td>
      <td><input type="text" id="text-medium" name="company" value="" class="large-field" /></td>
    </tr>
    <tr>
      <td><span class="required">*</span> <?php echo $entry_address_1; ?></td>
      <td><input type="text" id="text-medium" name="address_1" value="" class="large-field" /></td>
    </tr>
    <tr>
      <td><?php echo $entry_address_2; ?></td>
      <td><input type="text" id="text-medium" name="address_2" value="" class="large-field" /></td>
    </tr>
    <tr>
      <td><span class="required">*</span> <?php echo $entry_city; ?></td>
      <td><input type="text" id="text-medium" name="city" value="" class="large-field" /></td>
    </tr>
    <tr>
      <td><span class="required">*</span> <?php echo $entry_postcode; ?></td>
      <td><input type="text" id="text-medium" name="postcode" value="" class="large-field" /></td>
    </tr>
    <tr>
...
<br />
<div class="buttons">
  <div class="right"><a id="button-address" class="buttonlarge"><span><?php echo $button_continue; ?></span></a></div>
</div>
