...
<?php echo $content_top; ?>
    ...
    <?php if ($attention) { ?>
    <div id="notiffy-server"><?php echo $attention; ?></div>
    <?php } ?>    
    <?php if ($success) { ?>
    <div id="notiffy-server"><?php echo $success; ?></div>
    <?php } ?>
        ...
        <table>
          ...
          <tbody>
            ...
            <?php } ?>
                ...
                <div id="regbox-button">
                    <div id="left">
    <a class="buttonlarge" onclick="$('#basket').submit();"><span><?php echo $button_update; ?></span></a>
                    </div>
                ...
                <div id="regbox-button">
                    <div id="left">
    <a class="buttonlarge" href="<?php echo $checkout; ?>"><span><?php echo $button_checkout; ?></span></a>
                    </div>
    
                    <div id="right">
                    
    <a class="buttonlarge" href="<?php echo $continue; ?>"><span><?php echo $button_shopping; ?></span></a>
                    </div>
