...
<div id="notiffy-server-shipping"></div>
    ...
    <table id="shipping">
      ...
      <tr>
        ...
        <td><input type="text" name="postcode" value="<?php echo $postcode; ?>" /></td>
             ...
             <a class="buttonsmall" id="button-quote"><span><?php echo $button_quote; ?></span></a> 
		...
		success: function(json) {
			...
			if (json['error']) {
				if (json['error']['warning']) {
					$('#notiffy-server-shipping').html('<div id="notiffy-server">' + json['error']['warning'] + '</div>');
				}
			...
			if (json['shipping_methods']) {
				...
				html += '</table>';
				html += '<br /><a id="button-shipping" class="buttonsmall"><span><?php echo $button_shipping; ?></span></a>';				
...
$('#button-shipping').live('click', function() {
	$.ajax({
		...
		success: function(json) {
			if (json['error']) {
				$('#shipping').html('<div id="notiffy-server">' + json['error'] + '</div>');
			}
