    ...
    <div class="right">
      ...
      <div class="cart">
        <div><?php echo $text_qty; ?>
          <input type="text" name="quantity" size="2" value="<?php echo $minimum; ?>" style="width:10px;"/>
          <input type="hidden" name="product_id" size="2" value="<?php echo $product_id; ?>" />
          &nbsp;<a id="button-cart" class="button" onclick="addToCart('<?php echo $product_id; ?>');"><span><?php echo $button_cart; ?></span></a></div>
        <div><span>&nbsp;&nbsp;&nbsp;<?php echo $text_or; ?>&nbsp;&nbsp;&nbsp;</span></div>
        <div><a onclick="addToWishList('<?php echo $product_id; ?>');" class="button"><span><?php echo $button_wishlist; ?></span></a>
          <a onclick="addToCompare('<?php echo $product_id; ?>');" class="button"><span><?php echo $button_compare; ?></span></a></div>
        <?php if ($minimum > 1) { ?>
