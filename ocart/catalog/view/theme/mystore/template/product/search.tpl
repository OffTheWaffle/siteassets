...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="buttons">
    <div class="right">  <div class="buttn_log"><input type="button" value="<?php echo $button_search; ?>" id="button-search" class="button" /></div></div>
  </div>
  ...
  <div class="product-list">
    ...
    <div class="clsProductBox_search" >
