  ...
  <div class="cart-module">
    <div id="coupon" class="content" style="display: <?php echo ($next == 'coupon' ? 'block' : 'none'); ?>;">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
        ...
        &nbsp;
       <div class="buttn_log"> <input type="submit" value="<?php echo $button_coupon; ?>" class="button" /></div>
      </form>
    </div>
    <div id="voucher" class="content" style="display: <?php echo ($next == 'voucher' ? 'block' : 'none'); ?>;">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
        ...
        &nbsp;
        <div class="buttn_log"><input type="submit" value="<?php echo $button_voucher; ?>" class="button" /></div>
      </form>
    </div>
    <div id="reward" class="content" style="display: <?php echo ($next == 'reward' ? 'block' : 'none'); ?>;">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
        ...
        &nbsp;
        <div class="buttn_log" <input type="submit" value="<?php echo $button_reward; ?>" class="button" /></div>
      </form>
    </div>
    <div id="shipping" class="content" style="display: <?php echo ($next == 'shipping' ? 'block' : 'none'); ?>;">
      ...
      <div class="buttn_log"><input type="button" value="<?php echo $button_quote; ?>" id="button-quote" class="button" /></div>
    </div>
  </div>
  <?php } ?>
