...
<div id="content"><?php echo $content_top; ?>
  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="content clearfix" style="width:758px;">
      ...
      <div class="content">
        <div class="return-product">
          <div class="return-name"><span class="required">*</span> <b><?php echo $entry_product; ?></b><br />
            <input type="text" name="product" value="<?php echo $product; ?>" style="width:160px;" />
            <br />
          ...
          <div class="return-model"><span class="required">*</span> <b><?php echo $entry_model; ?></b><br />
            <input type="text" name="model" value="<?php echo $model; ?>" style="width:160px;" />
            <br />
            <?php if ($error_model) { ?>
            <span class="error"><?php echo $error_model; ?></span>
            <?php } ?>
          </div>
          <div class="return-quantity" style="width:0px"><b><?php echo $entry_quantity; ?></b><br />
            <input type="text" name="quantity" value="<?php echo $quantity; ?>" style="width:160px;" />
          </div>
        </div>
        <div class="return-detail">
          ...
          <div class="return-captcha" style="margin-right:136px"><b><?php echo $entry_captcha; ?></b><br />
    ...
    <div class="buttons">
      ...
      <div class="right">
        <div class="buttn_log"><input type="submit" value="<?php echo $button_continue; ?>" class="button" /></div>
      </div>
    </div>
  </form>
